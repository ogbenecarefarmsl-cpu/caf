...
export const AdminLayout = ({ children, title = 'Admin' }: AdminLayoutProps) => {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      roles: ['super_admin', 'branch_manager', 'pharmacist', 'auditor'],
    },
    {
      name: 'Products',
      path: '/admin/products',
    ...
    },
    {
      ...
      roles: ['super_admin', 'branch_manager', 'cashier', 'pharmacist', 'auditor'],
    },
    {
      name: 'POS Terminal',
      path: '/pos',
      ...
      roles: ['super_admin', 'branch_manager', 'pharmacist', 'cashier', 'auditor'],
    },
    {
      name: 'Customers',
